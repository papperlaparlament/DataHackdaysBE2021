...
public class DateTimeFieldType {
    ...
    @XmlElementRef(name = "Start", namespace = "http://www.cmiag.ch/cdws/Mitgliedschaften", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> start;
    @XmlElementRef(name = "End", namespace = "http://www.cmiag.ch/cdws/Mitgliedschaften", type = JAXBElement.class, required = false)
